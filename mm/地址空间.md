...
<img src="./pics/64-space.jpeg" width="100%"/></div>
<br/>
...
<div style="text-align:center">
<img src="./pics/memory-space.jpeg"  width="100%"/></div>
<br/>

<div style="text-align:center">
<img src="./pics/user-space.jpeg"  width="100%"/></div>
<br/>
...
<div style="text-align:center">
<img src="./pics/user-space-build-process.jpeg"  width="100%"/></div>
<br/>

在Linux中，每个segment用一个vm_area_struct（以下简称vma）结构体表示。vma是通过一个双向链表（早期的内核实现是单向链表）串起来的，现存的vma按起始地址以递增次序被归入链表中，每个vma是这个链表里的一个节点。

<div style="text-align:center">
<img src="./pics/mm_struct-and-vma.jpeg"  width="100%"/></div>
<br/>


<div style="text-align:center">
<img src="./pics/vma-link.jpeg" width="100%"/></div>
<br/>

<div style="text-align:center">
<img src="./pics/vma.png" width="100%" width="100%"/></div>
<br/>
...
<div style="text-align:center">
<img src="./pics/malloc.png" width="60%" width="100%"/></div>
<br/>
...
<div style="text-align:center">
<img src="./pics/sys_brk.png" width="100%" width="100%"/></div>
<br/>

<div style="text-align:center">
<img src="./pics/malloc-brk.png" width="100%" width="100%"/></div>
<br/>
...
<div style="text-align:center">
<img src="./pics/mmap.png" width="100%" width="100%"/></div>
<br/>
可以看到和sys_brk()十分相似。
...
```
<div style="text-align:center">
<img src="./pics/handle_mm_fault.png" width="100%" width="100%"/></div>
<br/>
...
<div style="text-align:center">
<img src="./pics/do_anonymous_page.png" width="100%" width="100%"/></div>
<br/>
...
```
<div style="text-align:center">
<img src="./pics/do_wp.png" width="100%" width="100%"/></div>
<br/>
关键的复制工作是由wp_page_copy完成的：
<div style="text-align:center">
<img src="./pics/do_wp_page.png" width="100%" width="100%"/></div>
<br/>
